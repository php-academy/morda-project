            ...
            foreach ($ads as $key => $carData) {
                if ($carData['id'] == $_GET['id']) {
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?=$carData['model']['name'];?></li>
                    </ol>

                    <div class="col-xs-1"><strong>Модель:</strong></div>
                    <div class="col-xs-11">
                        <?=$carData['model']['name'];?><br>
                        <?=$carData['model']['run'];?><br>
                        <?=$carData['model']['power'];?><br>
                        <?php if ($carData['model']['isAutoTrans'] == 'true') echo 'АКПП'; else echo 'МКПП'; ?><br>
                        <?php if ($carData['model']['is4wd'] == 'true') echo '4WD'; ?>
                    </div>

                    <div class="col-xs-1"><strong>Цена:</strong></div>
                    <div class="col-xs-11">
                        <?=$carData['price']['value'];?> <?=$carData['price']['currency'];?>
                    </div>
                    <?php break;
                }
            }
